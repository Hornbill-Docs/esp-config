...
The variable picker is available to use in most workflow nodes and their options, including:
...
* **Hornbill Automations** - This will list any variable data related to the entity in which the variable picker is being used. In order to have options presented here, you must use the relevant workflow Get Information nodes in the workflow stage prior to the node you want to make the variables available in.
