...
The [Request Attachment Archiver utility](https://github.com/hornbill/goRequestAttachmentArchiver) provides a simple, safe, and secure way to extract file attachments from a Hornbill instance. The utility downloads attachments from a Hornbill instance and saves them in a location on a local machine of your choice.
