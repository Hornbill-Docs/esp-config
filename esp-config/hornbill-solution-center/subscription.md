...
* **Application**: Name of the application that is installed and available in Hornbill.
* **Version**: The version that is currently installed in Hornbill.
* **Install Date**: The date on which the application was originally installed.
* **Subscriptions**: The number of subscribers currently subscribed to the app. Subscriptions listed as Unlimited are apps that do not require additional subscriptions and are available to all platform subscribers.
...
Support Passcodes have been designed to allow Customers to grant temporary access to their Instance should this be needed for Support to investigate an open issue. A Passcode will be generated against a particular user, allowing the Support Team Member the ability to investigate the behavior with the same access level as the user experiencing the issue.
