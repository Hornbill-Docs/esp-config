...
When viewing email template, any field that has a Field Expression applied is highlighted in gray.
To edit an ESP Expression, highlight the field and click the ESP Expression button.
