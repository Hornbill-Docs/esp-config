...
### Tool Bar
* **Filter**<br>A filter allows you to locate reports that you have already created.
* **Create New Report**<br>This option starts the process of creating a new report.
...
### General
* **Name**<br>The name of the report. This is displayed in the list of reports as well as providing the default title on the report output.
